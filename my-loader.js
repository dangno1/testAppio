(function () {
    ...
    function updateImportButtonState() {
        ...
        importBtn.disabled = !isEnabled;
        importBtn.style.background = isEnabled ? '#003366' : '#e4e5e7';
        importBtn.style.color = isEnabled ? '#fff' : '#8c9196';
        importBtn.style.cursor = isEnabled ? 'pointer' : 'not-allowed';
    }
    ...
    startBtn.addEventListener("click", async () => {
        ...
        async function processPage() {
            ...
            scrollToElement('.cm-cr-show-more');
            await wait(2000);
            if (!document.getElementById('appio-overlay')) return;
            ...
            const nextLi = document.querySelector('.cm-cr-show-more');
